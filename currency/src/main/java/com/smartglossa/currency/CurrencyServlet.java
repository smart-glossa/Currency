	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (operation.equals("add")) {
			...
			try {
				...
				Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/currency", "root",
						"root");
				Statement statement = connection.createStatement();
				String query = "insert into calculation(one,two,five,ten,twenty,fivty,oneh,fiveh,onet,twot,total)values("
						+ rs1 + "," + rs2 + "," + rs5 + "," + rs10 + "," + rs20 + "," + rs50 + "," + rs100 + "," + rs500
						+ "," + rs1000 + "," + rs2000 + "," + total + ")";
